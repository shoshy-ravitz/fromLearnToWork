...
namespace FromLearningToWorking.Data.Migrations
{
    ...
    [Migration("20250423221322_change-name-off-interviewQuestion-value")]
    partial class changenameoffinterviewQuestionvalue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FromLearningToWorking.Core.Entities.TotalResultInterview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FromLearningToWorking.Core.Entities.Interview", b =>
                {
                    ...
                    b.Navigation("TotalResultInterview");
                });
